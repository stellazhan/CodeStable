...
├── roadmap/                    规划层聚合根
├── goals/                      自主迭代目标聚合根（起点报告 / iteration / 功能验收）
├── features/                   feature 聚合根
├── issues/                     issue 聚合根
├── refactors/                  refactor 聚合根
├── brainstorm/                 brainstorm spike 临时区
├── brainstorms/                brainstorm / interview 持久记录聚合根
...
- `.codestable/{requirements,roadmap,goals,features,issues,refactors,compound,brainstorm,brainstorms}/.gitkeep`
...
- `.codestable/reference/tools-context.md` — context packet / finish / inbox / commit / backlog 工具补充说明
