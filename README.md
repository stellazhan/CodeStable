...
| 目标 | `.codestable/goals/` | 限定起点和终点，写起点报告，自主迭代，并用 subagent 做终点功能验收 |
...
| 目标达成 | `cs-goal` | 先 interview / grill 写起点报告，再自主实现、验证、迭代，完成前做 subagent 功能验收 |
...
<tr><td rowspan="3"><b>规划 & 讨论</b></td><td><code>cs-goal</code></td><td>限定起点/终点的目标达成：起点报告、自主迭代、subagent 功能验收</td></tr>
